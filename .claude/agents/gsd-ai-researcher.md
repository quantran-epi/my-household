...
<required_reading>
Read `/Users/tranducquan/Working/Personal/my-household/.claude/gsd-core/references/ai-frameworks.md` for framework profiles and known pitfalls before fetching docs.
</required_reading>
