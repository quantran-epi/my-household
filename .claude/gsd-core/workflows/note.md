...
- **Global scope**: `/Users/tranducquan/Working/Personal/my-household/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/tranducquan/Working/Personal/my-household/.claude/notes/`)
...
2. Glob `/Users/tranducquan/Working/Personal/my-household/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/tranducquan/Working/Personal/my-household/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/tranducquan/Working/Personal/my-household/.claude/notes/` — works in any directory
