...
The keys live in `.claude/settings.json` (project) or `/Users/tranducquan/Working/Personal/my-household/.claude/settings.json` (global) — **not** in `.planning/config.json`:
