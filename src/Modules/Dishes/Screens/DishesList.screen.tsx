...
const LazyDishesNutritionUsageModal = React.lazy(() => import("./DishesNutritionUsageModal.widget").then(module => ({ default: module.DishesNutritionUsageModal })));
...
const DishesItemComponent: React.FunctionComponent<DishesItemProps> = (props) => {
    ...
    const toggleNutritionUsage = useToggle();
    ...
    return <React.Fragment>
                ...
                <div style={{ minWidth: 0, display: "flex", flexDirection: "column", gap: 7 }}>
                    <div style={{ display: "grid", gridTemplateColumns: "minmax(0, 1fr) auto", gap: 8, alignItems: "start" }}>
                        ...
                        <Dropdown menu={{
                            ...
                            <Button type="text" data-testid={`dish-row-menu-${props.item.id}`} icon={<MoreOutlined />} style={{ width: 32, paddingInline: 0 }} />
                        </Dropdown>
                    </div>
        ...
        {toggleNutritionUsage.value && <React.Suspense fallback={null}>
            <LazyDishesNutritionUsageModal dish={props.item} open={toggleNutritionUsage.value} onClose={toggleNutritionUsage.hide} />
        </React.Suspense>}
