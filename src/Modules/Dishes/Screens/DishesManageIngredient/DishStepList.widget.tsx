import { DeleteOutlined, DoubleLeftOutlined, DoubleRightOutlined, MoreOutlined, QuestionCircleOutlined, EditOutlined } from "@ant-design/icons"
    ...
    const _onMoreActionClick = (e) => {
        switch (e.key) {
            ...
            case "remove": modal.confirm({
                content: "Xóa bước nấu này khỏi món?",
                okText: "Xóa",
                cancelText: "Hủy",
                centered: true,
                onOk: () => {
    ...
    return <React.Fragment>
        <Stack fullwidth justify="space-between" align="flex-start">
            ...
            <Dropdown menu={{
                ...
                <Button type="text" icon={<MoreOutlined />} style={{ width: 32, paddingInline: 0 }} />
            </Dropdown>
        </Stack>
