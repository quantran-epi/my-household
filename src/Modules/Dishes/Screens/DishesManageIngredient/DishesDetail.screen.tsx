...
export const DishesDetailScreen = () => {
    ...
    const _confirmDelete = () => {
        modal.confirm({
            title: "Xóa món ăn",
            content: "Bạn chắc chắn muốn xóa món ăn này?",
            okText: "Xóa",
            cancelText: "Huỷ",
    ...
    usePageActions(isAdmin && currentDish ? [
        { key: "edit", label: "Chỉnh sửa", icon: <EditOutlined />, onClick: toggleEdit.show },
        { key: "delete", label: "Xóa món ăn", icon: <DeleteOutlined />, danger: true, onClick: _confirmDelete },
    ] : [], [isAdmin, currentDish]);
    ...
    return (
        <React.Fragment>
            ...
            {/* ── Detail content ── */}
            <div style={{ padding: "12px 12px 24px", background: "#fff" }}>
