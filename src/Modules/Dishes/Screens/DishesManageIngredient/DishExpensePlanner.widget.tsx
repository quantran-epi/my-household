                ...
                <div style={{ display: "flex", flexDirection: "column", gap: 10, width: "100%" }}>
                    ...
                    <div style={{ display: "flex", flexDirection: "column", gap: 8, width: "100%" }}>
                        ...
                        {selectedDishDetails.map(item => <div key={item.dish.id} style={{
                            ...
                            />
                            {allowDishSelection && <ActionButton onClick={() => setPreviewDish({ dish: item.dish, servings: item.servings })}>
                                Chi tiết
                            </ActionButton>}
                            {allowDishSelection && <ActionButton tone="danger" onClick={() => _onRemoveDish(item.dish.id)}>
                                Gỡ
                            </ActionButton>}
                        </div>)}
                    </div>
