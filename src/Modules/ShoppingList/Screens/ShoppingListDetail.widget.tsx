...
import { Divider, Space, Spin, Tabs } from "antd";
                    ...
                    <List
                        ...
                        >
                            <Stack gap={8} justify="space-between" align="flex-start" fullwidth>
                                <Typography.Paragraph style={{ width: "100%", marginBottom: 0, color: "#0958d9" }} ellipsis={{ rows: 2 }}>{item.name}</Typography.Paragraph>
...
export const ShoppingListDishesItem: React.FunctionComponent<ShoppingListDishesItemProps> = (props) => {
    ...
    return <React.Fragment>
        <List.Item
            data-testid={`shopping-list-dish-${props.dish.id}`}
            role="button"
            tabIndex={0}
        ...
        >
            <Stack gap={8} justify="space-between" align="flex-start" fullwidth>
                <div style={{ minWidth: 0, flex: 1 }}>
                    <Typography.Paragraph style={{ width: "100%", marginBottom: 2, color: "#0958d9" }} ellipsis={{ rows: 2 }}>{props.dish.name}</Typography.Paragraph>
