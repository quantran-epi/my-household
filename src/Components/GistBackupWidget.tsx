                    ...
                    <Flex vertical gap={8}>
                        ...
                        <div style={{ border: "1px solid #f0f0f0", borderRadius: 8, padding: "8px 10px", background: "#fafafa" }}>
                            <Flex align="center" justify="space-between" gap={8}>
                                ...
                                <ActionButton shape="circle" icon={<ReloadOutlined />} aria-label="Làm mới dung lượng dữ liệu" onClick={_refreshDataSize} />
                            </Flex>
                        ...
                        />
                        {!isSaved && (
                            <ActionButton tone="primary" block onClick={_onSave}>
                                Lưu cấu hình
                            </ActionButton>
                        )}
                        <ActionButton
