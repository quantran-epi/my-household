...
import { CookingHistoryScreen } from "@modules/Dishes/Screens/CookingHistory.screen";
...
import { SmartPlannerTemplatesScreen } from "@modules/ScheduledMeal/Screens/SmartPlannerTemplates.screen";
...
export const RootRouter = () => {
    return <BrowserRouter basename="/my-recipes">
        <Routes>
            ...
            <Route path={RootRoutes.AuthorizedRoutes.Root()} element={<PageActionsProvider><MasterPage /></PageActionsProvider>}>
                <Route index element={<DashboardScreen />} />
                <Route path={RootRoutes.AuthorizedRoutes.Analytics()} element={<DashboardAnalyticsScreen />} />
                <Route path={RootRoutes.AuthorizedRoutes.CookingHistory()} element={<CookingHistoryScreen />} />
