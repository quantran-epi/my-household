...
- [x] **COPY-04**: All user-facing labels and descriptions read natural to a local Vietnamese user — no English or technical-jargon leftovers (automated clean in Phase 5; native-speaker UAT follow-up recorded)
...
- [x] **MOB-04**: Retired as written for v1 — phone-only user; desktop no longer gated per Phase 5 CONTEXT D-07
